...
public class UsuarioController {
    ...
    public void deletar(ActionEvent evento) {
        ...
        try {
            if (dao.isUsuarioComHost(usuario.getId())) {
                message.error("Usuário em uso. Remova o usuário \"" + usuario.getNome() + "\" dos hosts ");
                return;
            } 
            dao.deletar(usuario);
            ...
            System.out.println("Erro ao deletar uuário: " + ex);
        }
    }
